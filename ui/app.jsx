...
function SettingsPage({ connection, health, navigate, onToast }) {
...
export function App() {
  ...
  else if (route.pathname.startsWith('/configuracoes')) content = <SettingsPage connection={connection} health={health} navigate={navigate} onToast={setToast} />;
